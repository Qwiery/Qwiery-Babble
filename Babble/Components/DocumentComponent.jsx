    ...
    render: function() {
        if(this.state.mode === "error") {
            ...
            return <div id={this.componentId} key={this.componentId}>
                <p>The document cannot be embedded here, you need to click on the link below to open it:</p>
                <p><img src={adr} style={{"width":"15px", "margin":"0 5px"}}/><a target="_blank" href={Qwiery.serviceURL + "/uploads/" + this.entity.Source} style={{width: "100%", padding: 15}}>{this.entity.Title}</a></p>
            </div>;
