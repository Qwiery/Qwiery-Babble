    ...
    render: function() {
        if(this.state.mode === "error") {
            ...
            return <div id={this.componentId} key={this.componentId}>
                ...
                <div>Priority: {this.entity.Priority}</div>
            </div>;
        } else if(this.state.mode === "edit") {
            return <div id={this.componentId} key={this.componentId}>

                <form id="PersonEditor">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="FirstName" value="$FirstName" width="150" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input name="LastName" value="$LastName" width="150" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <div>
                                    <input id="PersonSubmit" type="button" value="Save" /> <span id="Feedback" style="margin-left: 10px; color: limegreen;"></span>
                                </div>
                            </td>
                        </tr>
                    </table>
